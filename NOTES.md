...
## Supabase
- Tables: `profiles`, `checkins`, `food_reviews` (has `spot`, `photo_url`), `photos`, `food_favorites`, `wait_times`. See `supabase/schema.sql`.
